...
print(res_destnation.status_code,end="\n\n") # 打印响应码

if res_destnation.status_code == 200:
    ...
    for tag_article in list_articles: # 遍历列表
        ...
        print("the link: " + tag_url['href']+"\n")  # 换行打印文章链接，需要使用属性名提取属性值
        print("".center(80,'-'))
        time.sleep(0.5)
else:
    print("not receive response from website")
